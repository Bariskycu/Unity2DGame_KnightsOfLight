...
public class Player_Level_2 : Character
{

    private static Player_Level_2 instance;

    public event DeadEventHandler Dead;

    public static Player_Level_2 Instance
    {
        get
        {
            if (instance == null)
            {
                instance = GameObject.FindObjectOfType<Player_Level_2>();
            }
            return instance;
        }
    }
